...
public interface DocDAO {
	...
	public List<DocVO> selectIng(String emp_num, int page) throws Exception; //내가 올린 기안 진행중보기(page 매개변수 추가) 진행중인거 state = 1
	public List<DocVO> selectAll(String emp_num, int page) throws Exception; //내가 올린 기안 다 보기(page 매개변수 추가)
	public List<DocVO> selectOk(String emp_num) throws Exception; //내가 올린 기안 완료   
	public List<DocVO> selectOk(String emp_num, int page) throws Exception;//내가 올린 기안 완료(page 매개변수 추가)
