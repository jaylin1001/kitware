...
public class BoardService {
	...
	public void insertDeptBoard(DepartBoard departboard) throws Exception {
		dao.insertDeptBoard(departboard);
	}

	public List<Comment> getComment(int seq) throws Exception {
		return dao.getCommentList(seq);
	}

	public void insertComment(int seq, Members m, String content) throws Exception {
		dao.insertComment(seq, m, content);
	}
	...
	public void updateDeptBoard(DepartBoard deptBoard) throws Exception {
		dao.updateDeptBoard(deptBoard);
	}

	public void updateDeptHit(String hitseq) throws Exception {
		dao.updateDeptHit(Integer.parseInt(hitseq));
	}
	public int findCount(int dept_num) throws Exception {
		return dao.selectDeptCount(dept_num);
	}
	public List<DepartBoard> findAll(int page, int dept_num) throws Exception {
		return dao.getListBoard(page, dept_num);
	}

	public void deleteDeptBoard(int delseq) throws Exception{
		dao.delDeptBoard(delseq);
	}

	public void updateDeptBoardFile(DepartBoard deptBoard) throws Exception{
		dao.updateDeptBoardFile(deptBoard);
	}
