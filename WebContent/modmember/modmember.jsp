...
<script>
	$(function() {
		var deptnum = ${rs.dept_num};
		var positionnum = ${rs.position_num};
		$('#dept_num option[value='+ deptnum+']').attr('selected', 'selected');	
		$('#position_num option[value='+ positionnum +']').attr('selected', 'selected');
		...
		<div class="col-lg-12 well">
			<div class="row">
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>사원번호</label> <input type="text" required="required"
									class="form-control" name="emp_num" value="${rs.emp_num}"
									id="emp_num">
							</div>
							<div class="col-sm-6 form-group">
							<label>부서번호</label><select required="required" id="dept_num"
							...
							<div class="col-sm-6 form-group">
							<label>직급번호</label><select required="required" id="position_num"
							...
							<div class="col-sm-6 form-group">
								<label>ID</label> <input type="text" required="required"
									class="form-control" name="id" value="${rs.id}">
							</div>
						</div>

						<div class="row">
							<div class="col-sm-4 form-group">
								<label>비밀번호</label> <input type="text" required="required"
									class="form-control" name="pwd" value="${rs.pwd}">

							</div>
							<div class="col-sm-4 form-group">
								<label>이름</label> <input type="text" required="required"
									class="form-control" name="name" value="${rs.name}">
							</div>
							<div class="col-sm-4 form-group">
								<label>성별</label> <input type="text" required="required"
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>email 1</label> <input type="text" required="required"
									class="form-control" name="email1" value="${rs.email1}">
							</div>
							<div class="col-sm-6 form-group">
								<label>email 2</label> <input type="text" required="required"
									class="form-control" name="email2" value="${rs.email2}">
							</div>
							<div class="col-sm-6 form-group">
								<table>
									<tr>
										...
										<td><input type="text" style="display: inline;"
											class="form-control" required="required" name="tel1"
											placeholder="010" value="${rs.tel1}"></td>
										<td><input type="text" style="display: inline;"
											class="form-control" required="required" name="tel2"
											placeholder="xxxx" value="${rs.tel2}"></td>
										<td><input style="display: inline;" type="text"
											class="form-control" required="required" name="tel3"
											placeholder="xxxx" value="${rs.tel3}"></td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="memberdetail" id="memberdetail">
							<table>
								<tr>
									...
									<td><input required="required" name="birth1"
										placeholder="yyyy" class="form-control" value="${rs.birth1}"></td>
									<td><input required="required" name="birth2"
										placeholder="mm" class="form-control" value="${rs.birth2}"></td>
									<td><input required="required" name="birth3"
										placeholder="dd" class="form-control" value="${rs.birth3}"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input class="form-control" required="required"
										name="zip1" value="${rs.zip1}"><input
										class="form-control" name="zip2" value="${rs.zip2}"></td>
								</tr>
								<tr>
				...
				<input type="submit" form="modmember" value="저장"
					...
					type="button" id="delete" class="btn btn-lg btn-info" value="회원삭제">
