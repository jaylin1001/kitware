...
<body>
   <div>
      <div class="outtable">
         ...
         <table class="table table-bordered">
         <tr>
            <td style="width:80%; text-align:center; font-size: 17px;">댓글작성</td><td style="width:20%"><button id="cmgo">작성</button></td>
         </tr>
         <tr>
         <td colspan="10"><textarea class="cmcontent" style="width:100%;height:200px"></textarea></td>
         </tr>
         </table>
