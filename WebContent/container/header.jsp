...
<script>
	$(function() {
		...
		/* $('.nav>li.gian').click(function() {
			...
			$.ajax({
				method : 'POST',
				url : '${pageContext.request.contextPath}/docwriteinfo.do',
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li class="authorization"><a href="#" id="write">결재문서작성<span
								class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li class="gian"><a href="${pageContext.request.contextPath}/docwriteinfo.do?kind=gian">기안서</a></li>
								<li class="pumyee"><a href="${pageContext.request.contextPath}/docwriteinfo.do?kind=pumyee">품의서</a></li>
								<li class="chuljang"><a href="${pageContext.request.contextPath}/docwriteinfo.do?kind=chuljang">출장신청</a></li>
								<li class="byungga"><a href="${pageContext.request.contextPath}/docwriteinfo.do?kind=byungga">병가신청</a></li>
								<li class="jotae"><a href="${pageContext.request.contextPath}/docwriteinfo.do?kind=jotae">조퇴신청</a></li>
								<li class="balju"><a href="${pageContext.request.contextPath}/docwriteinfo.do?kind=balju">발주서</a></li>
							</ul></li>
