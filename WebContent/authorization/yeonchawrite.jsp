		...
		<div class="table">
			<table class="table table-bordered">
               ...
               id="testDatepicker" placeholder="날짜를 선택하세요" readonly> -->
				...
				<tr>
					...
					<td colspan="5">
						<div class="replace">
							...
							</select> <select name="name" class="name" required>
				...
				<tr>
					<td colspan="6" align="center">상기와 같은 사유로 인하여 제출하오니 재가바랍니다.</td>
				</tr>
				<tr>
					...
					function() {
						if ($(this).val() == '부서 선택') {
							$(this).siblings('.grade').children('option#init')
									.show();
							$(this).siblings('.grade').children('option')
									.hide();
						} else {
							$(this).siblings('.grade').children('option')
									.show();
			...
			$('.grade')
					.change(
							function() {
								...
								$(this).siblings('.name').children(
										'option#init').prop('selected', true);
							});
